# -*- coding: utf-8 -*-
{
    ...
    "description": """
Icon Picker Widget for Odoo 19
==============================

A powerful and user-friendly OWL widget that adds a visual icon picker to any
Char field in Odoo 19 backend views. Instead of manually typing icon class names,
...
* **OWL Component** — Built with Odoo 19's modern OWL framework for optimal performance.
